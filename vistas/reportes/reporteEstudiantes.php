...
<div class="container mt-4">
    <div class="card shadow">
        <div class="card-header bg-info text-white">
            <h3 class="mb-0"><i class="fa fa-file-pdf"></i> Reporte de Estudiantes</h3>
            <p class="mb-0">Generar lista de estudiantes en formato PDF</p>
        </div>
        
        <div class="card-body">
            <form action="../../controladores/reporteController/generarListaEstudiantes.php" method="POST" target="_blank">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="estado_academico"><i class="fa fa-user-graduate"></i> Estado Académico</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="incluir_academico" id="incluir_academico" checked>
                                <label class="form-check-label" for="incluir_academico">Datos Académicos</label>
                            </div>
                        </div>
                    </div>
                </div>
